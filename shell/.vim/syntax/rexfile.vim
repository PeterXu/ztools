...
syn match perlStatementRex		"\<\%(desc\|task\|group\|user\|sudo\|sudo_password\|timeout\|logging\|parallelism\|password\|pass_auth\|private_key\|public_key\|key_auth\|run\|upload\|pkg\|file\)\>"
...
if !exists("perl_no_extended_vars")
  syn cluster perlExpr		contains=perlStatementIndirObjWrap,perlStatementScalar,perlStatementRegexp,perlStatementNumeric,perlStatementList,perlStatementHash,perlStatementFiles,perlStatementTime,perlStatementMisc,perlStatementRex,perlVarPlain,perlVarPlain2,perlVarNotInMatches,perlVarSlash,perlVarBlock,perlVarBlock2,perlShellCommand,perlFloat,perlNumber,perlStringUnexpanded,perlString,perlQQ,perlArrow,perlBraces
...
HiLink perlStatementRex 	perlStatement
